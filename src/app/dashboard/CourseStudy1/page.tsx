...
import Sidebar from '@/components/courseComponents/Sidebard1';
import CourseContent1 from '@/components/courseComponents/CourseContent1';
          ...
          <main className="flex-1 p-4 lg:p-6 w-full">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="bg-white rounded-xl shadow-sm p-4 lg:p-8 mb-8">
                <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">Master Cyber-Security Online Course</h1>
              ...
              <CourseContent1 currentChapter={currentChapter} />
