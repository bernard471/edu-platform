...
import Sidebar from '@/components/courseComponents/Sidebard2';
import CourseContent2 from '@/components/courseComponents/CourseContent2';
import Header from '@/components/courseComponents/CourseStudyHeader';
import Footer from '@/components/footer/Footer';
import { TerminalContextProvider } from 'react-terminal';
import { useSearchParams } from 'next/navigation';
import { courseCategories } from '@/components/coursedata/chapters1';
          ...
          <main className="flex-1 p-4 lg:p-6 w-full">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="bg-white rounded-xl shadow-sm p-4 lg:p-8 mb-8">
                <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">Introduction to Kali Linux, Setup, Linux Basics, and Tools
                </h1>
                <p className="text-gray-600 mb-6">
                  Learn the fundamentals of Kali linux, including basic concepts, terminology, and best practices
              ...
              <CourseContent2 currentChapter={currentChapter} />
